...
@Component
public class IngestionConsumer extends AbstractStageConsumer {

    public IngestionConsumer(StageExecutionService stageExecutionService) {
    ...
    @RabbitListener(
            queues = "ar.ingestion.q",
            concurrency = "${ar.consumers.ingestion.concurrency:5-10}"
    )
