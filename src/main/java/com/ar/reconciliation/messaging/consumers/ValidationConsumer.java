...
@Component
public class ValidationConsumer extends AbstractStageConsumer {

    public ValidationConsumer(StageExecutionService stageExecutionService) {
    ...
    @RabbitListener(
            queues = "ar.validation.q",
            concurrency = "${ar.consumers.validation.concurrency:3-5}"
    )
